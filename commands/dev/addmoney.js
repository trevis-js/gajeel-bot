...
.setDescription(`Parece que você não é meu desenvolvedor para setar cruzeiros!`)
    ...
    message.channel.send(`O desenvolvedor ${message.author} setou ${args[0]} cruzeiros no usuário ${member}!`)
